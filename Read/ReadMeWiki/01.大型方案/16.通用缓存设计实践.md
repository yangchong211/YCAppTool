...
- 思考一个K-V框架的设计
    ...
    - 问题 13 - 研发体验： 是否模板代码冗长，是否容易出错。各种K—V框架使用体验如何？
...
- 
    - 参考：https://gds.51cto.com/posts/176
...
#### 4.4 缓存的过期处理
- 如果你使用该库中的淘汰算法LRU相关功能，那么涉及到缓存过期处理
    - 
...
- 存储库依赖的关系
    ...
    - 如果你要拓展其他的存储方案，则需要添加依赖。需要注意，添加的库使用compileOnly。
