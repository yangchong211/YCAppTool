package com.yc.video.ui.adapter;
        ...
        public void setData(MultiNewsArticleDataBean item) {
            ...
            if (null != item.getVideo_detail_info()) {
                if (null != item.getVideo_detail_info().getDetail_video_large_image()) {
                    ...
                    if (!TextUtils.isEmpty(image)) {
                        GlideImageUtils.loadImageNet(getContext(),image, R.drawable.image_default,ivVideoImage);
                    }
                }
            } else {
            ...
            if (null != item.getUser_info()) {
                ...
                if (!TextUtils.isEmpty(avatarUrl)) {
                    GlideImageUtils.loadImageNet(getContext(),avatarUrl, R.drawable.image_default,ivMedia);
                }
            }
