        ...
        public void setData(GanKIoDataBean.ResultsBean data) {
            ...
            if("福利".equals(data.getType())){
                if(data.getImages()!=null && data.getImages().size()>0){
                    ...
                    GlideImageUtils.loadImageNet(getContext(),data.getImages().get(0),R.drawable.shape_load_error_img,iv_all_welfare);
                } else {
                ...
                if(data.getImages()!=null && data.getImages().size()>0){
                    ...
                    GlideImageUtils.loadImageNet(getContext(),data.getImages().get(0),R.drawable.shape_load_error_img,iv_android_pic);
                } else {
