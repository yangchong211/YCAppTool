...
public class GanKHomeActivity extends BaseActivity implements View.OnClickListener , GanKHomeAContract.View{
    ...
    public void setBanner(String imgUrl) {
        GlideImageUtils.loadImageNet(this, imgUrl,
                R.drawable.ic_show_error, ivHomeBanner, new GlideImageUtils.CallBack() {
            @Override
    ...
    public void cacheImg(final String imgUrl) {
        // 预加载 提前缓存好的欢迎图
        GlideImageUtils.loadImageNet(this, imgUrl,
                R.drawable.ic_show_error, null, new GlideImageUtils.CallBack() {
                    @Override
                    public void onLoadFailed() {
