...
public class DouMusicDetailActivity extends BaseActivity {
    ...
    private void initIntentData() {
        ...
        if(intent!=null){
            ...
            GlideImageUtils.loadImageNet(DouMusicDetailActivity.this, image,ivMusicPhoto);
    ...
    private void setPicture() {
        GlideImageUtils.loadImageNet(this,image,R.drawable.image_default,ivMusicPhoto);
        GlideImageUtils.loadImageNet(this,image,R.drawable.bg_stack_blur_default,imgMusicItemBg);
    }
    ...
    private void setImgHeaderBg() {
        GlideImageUtils.loadImageNet(this,image,ivTitleHeadBg,false);
    }
