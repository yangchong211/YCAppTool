 ...
 * </pre>
 */
public class PieEasyView extends View {
    ...
    public PieEasyView(Context context) {
        this(context, null);
    }

    public PieEasyView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PieEasyView(Context c, @Nullable AttributeSet attrs, int defStyleAttr) {
