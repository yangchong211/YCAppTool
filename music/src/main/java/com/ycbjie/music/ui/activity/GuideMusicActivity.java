...
public class GuideMusicActivity extends BaseActivity implements View.OnClickListener ,
    ...
    public void initView() {
        ...
        Callback callback = new Callback() {
            ...
            public void onError() {
                //加载失败
                ivSplashAd.setBackgroundResource(R.drawable.play_page_default_bg);
            }
        };
        ImageUtils.loadImgByPicasso(this,null,
                R.drawable.play_page_default_bg,ivSplashAd,callback);
    }
