...
import static com.yc.alive.util.SystemPropertiesUtils.UNKNOWN;

/**
 * Rom 工具类
 */
@RestrictTo(LIBRARY)
public class AliveRomUtils {
    ...
    public static boolean isOppo(AliveDeviceModel device) {
        ...
        if (AliveStringUtils.isEmpty(device.romOppoVersionName)) {
            return false;
        }
    ...
    public static boolean isVivo(AliveDeviceModel device) {
        ...
        if (AliveStringUtils.isEmpty(device.romVivoVersionName)) {
            return false;
        }
    ...
    public static boolean isEmui(AliveDeviceModel device) {
        ...
        if (AliveStringUtils.isEmpty(device.romEmuiVersionName)) {
            return false;
        }
    ...
    public static boolean isMiui(AliveDeviceModel device) {
        ...
        if (AliveStringUtils.isEmpty(device.romMiuiVersionName)) {
            return false;
        }
    ...
    public static boolean isSamsung(AliveDeviceModel device) {
        ...
        if (AliveStringUtils.isEmpty(device.manufacturer)) {
            return false;
        }
    ...
    public static boolean isSmart(AliveDeviceModel device) {
        ...
        if (AliveStringUtils.isEmpty(device.romSmartisanVersionName)) {
            return false;
        }
