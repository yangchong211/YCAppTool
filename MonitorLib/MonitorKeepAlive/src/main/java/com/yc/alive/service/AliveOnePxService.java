...
import com.yc.alive.ui.AliveOnePxActivity;
 ...
 */
@RestrictTo(LIBRARY)
public class AliveOnePxService extends Service {
    ...
    public static void launch(Context context) {
        try {
            ...
            Intent intent = new Intent(context, AliveOnePxService.class);
    ...
    public static void stop(Context context) {
        context.stopService(new Intent(context, AliveOnePxService.class));
    }
    ...
    private void startActivity() {
        AliveOnePxActivity.launch(getApplicationContext());
    }
    ...
    private class ScreenBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (AliveStringUtils.isEmpty(action)) {
                return;
            }
    ...
    public class MyBinder extends Binder {
        public AliveOnePxService getService() {
            return AliveOnePxService.this;
        }
    }
