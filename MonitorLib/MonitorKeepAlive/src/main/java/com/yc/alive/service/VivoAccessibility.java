...
public class VivoAccessibility extends BaseAccessibility {
    ...
    @Override
    protected void processFloatWindow(AccessibilityService service, AccessibilityNodeInfo rootNode, String className, AliveOptionModel option, OnProcessCallback callback) {
