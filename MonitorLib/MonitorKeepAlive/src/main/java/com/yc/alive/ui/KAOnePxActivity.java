 ...
 */
@RestrictTo(LIBRARY)
public class KAOnePxActivity extends Activity {
    ...
    public static void launch(Context context) {
        try {
            Intent intent = new Intent(context, KAOnePxActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    KAOnePxService.MyBinder binder = (KAOnePxService.MyBinder) service;
                    binder.getService().bindActivity(KAOnePxActivity.this);
        ...
        bindService(new Intent(this, KAOnePxService.class), mConn, BIND_AUTO_CREATE);
    }
