...
import static com.yc.alive.util.KAAccessibilityUtils.refresh;
 ...
 */
@RestrictTo(LIBRARY)
public class KAEmuiAccessibility extends BaseAccessibility {
        ...
        KAExecutorUtils.getInstance().runWorker(new KAExecutorUtils.KARunnable() {
            ...
            public void runWorker() {
                if (CLASS_BATTERY_EMUI_V11.equals(className)) {
                    ...
                    if (gv == null) {
                        gv = KAAccessibilityUtils.findNodeById(rootNode, AliveSettingConst.ID_BATTERY_LIST_ID_EMUI_V11);
                    }
                }
            }
        ...
        if (CLASS_BATTERY_EMUI_V11.equals(className)) {
            KAExecutorUtils.getInstance().runWorker(new KAExecutorUtils.KARunnable() {
                ...
                public void runWorker() {
                    ...
                    if (lv == null) {
                        lv = KAAccessibilityUtils.findNodeById(rootNode, AliveSettingConst.ID_BATTERY_LIST_ID_EMUI_V11);
                    }
                }
