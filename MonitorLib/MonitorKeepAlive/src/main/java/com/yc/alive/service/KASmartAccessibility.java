...
import static com.yc.alive.util.KAAccessibilityUtils.getSmartCheckableNode;
import static com.yc.alive.util.KAAccessibilityUtils.getSmartCheckableNodeList;

/**
 * Smart 事件处理
 */
@RestrictTo(LIBRARY)
public class KASmartAccessibility extends BaseAccessibility {
    ...
    private void processNotification2_5(final AccessibilityService service, AccessibilityNodeInfo rootNode,
                                        String className, AliveOptionModel option, final KAProcessCallback callback) {
    ...
    private void processWifi2_5(final AccessibilityService service, AccessibilityNodeInfo rootNode, String className,
        ...
        if (CLASS_WIFI_SETTING_V2.equals(className)) {
            ...
            findListItemNode(lvNode, service.getString(option.wifiKeepLiveRes), new KAAccessibilityUtils.Runnable() {
                @Override
    ...
    private void processSelfStart2_5(final AccessibilityService service, final AccessibilityNodeInfo rootNode, String className,
        ...
        if (CLASS_PERMISSION_SMART.equals(className)) {
            ...
            getSmartCheckableNodeList(sv, new KAAccessibilityUtils.ListRunnable() {
                @Override
