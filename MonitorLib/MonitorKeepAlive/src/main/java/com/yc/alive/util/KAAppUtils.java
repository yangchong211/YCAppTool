...
public class KAAppUtils {
    ...
    public static boolean openAccessibilitySettingPage(Context context) {
        ...
        return KAIntentUtils.launch(context, intent, false);
    }
    ...
    public static boolean open(Context context, AliveOptionModel option) {
        ...
        if (option.intent.type == AliveIntentType.ACTION) {
            ...
            return KAIntentUtils.launch(context, i, false);
        } else {
            return KAIntentUtils.launch(context, option.intent.packageName, option.intent.className, false);
        }
    }
