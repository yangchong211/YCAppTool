 ...
 *  2018/7/9.
 */
public class KAExecutorUtils {

    private static final String TAG = "KAExecutorUtils";

    private ExecutorService mExecutorService;

    private KAExecutorUtils() {
    }

    private static final class InnerHolder {
        private static final KAExecutorUtils INSTANCE = new KAExecutorUtils();
    }

    public static KAExecutorUtils getInstance() {
