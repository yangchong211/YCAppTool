...
import com.yc.photo.engine.ImageEngine;
import com.yc.photo.filter.Filter;
import com.yc.photo.internal.entity.CaptureStrategy;
import com.yc.photo.internal.entity.SelectionSpec;
import com.yc.photo.listener.OnCheckedListener;
import com.yc.photo.listener.OnSelectedListener;
import com.yc.photo.ui.MatisseActivity;
...
public final class SelectionCreator {
     ...
     * storage and also a authority for
     *
     ...
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator thumbnailScale(@FloatRange(from = 0.0f, to = 1.0f) float scale) {
