package com.ns.yc.lifehelper.ui.me.activity;
...
public class MeRegisterActivity extends BaseActivity implements View.OnClickListener {
    ...
    private MeRegisterActivity activity;
    ...
    public void initView() {
        activity = MeRegisterActivity.this;
        initToolBar();
    }
    ...
    private void goToRegister() {
        ...
        if(!pwd.equals(pwdAgain)){
            ToastUtil.showToast(activity,"两次输入密码不同");
            return;
        }
        ...
        EventBus.getDefault().post(new LoginSuccessEvent("发布事件-注册"));                        //发布事件
        this.finish();
    }
