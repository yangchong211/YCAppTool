...
import com.ns.yc.lifehelper.ui.other.douMovie.adapter.MovieTopAdapter;
...
public class MovieTopActivity extends BaseActivity implements View.OnClickListener {
    ...
    private MovieTopActivity activity;
    ...
    public void initView() {
        activity = MovieTopActivity.this;
        initToolBar();
        initRecycleView();
    }
    ...
    private void initRecycleView() {
        ...
        adapter = new MovieTopAdapter(activity);
