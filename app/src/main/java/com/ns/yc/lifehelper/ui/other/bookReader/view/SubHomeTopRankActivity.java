...
import com.ns.yc.lifehelper.ui.other.bookReader.adapter.SubHomeTopAdapter;
...
public class SubHomeTopRankActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SubHomeTopRankActivity activity;
    ...
    public void initView() {
        activity = SubHomeTopRankActivity.this;
        initToolBar();
        initIntentData();
        initRecycleView();
    }
    ...
    private void initRecycleView() {
        ...
        adapter = new SubHomeTopAdapter(activity);
