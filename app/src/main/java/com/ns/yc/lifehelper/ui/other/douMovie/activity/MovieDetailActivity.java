package com.ns.yc.lifehelper.ui.other.douMovie.activity;
...
import com.ns.yc.lifehelper.ui.other.douMovie.adapter.MovieDetailAdapter;
...
public class MovieDetailActivity extends BaseActivity {
    ...
    public void initView() {
        activity = MovieDetailActivity.this;
        initToolBar();
        initIntent();
    }
    ...
    private void initIntent() {
        ...
        ImageUtils.loadImgByPicasso(activity,image,ivHeaderPhoto);
                ...
                .subscribe(new Subscriber<DouMovieDetailBean>() {
                    ...
                    public void onNext(final DouMovieDetailBean movieDetailBean) {
                        if(movieDetailBean!=null){
                            ...
                            final MovieDetailAdapter adapter = new MovieDetailAdapter(movieDetailBean.getCasts(),activity);
