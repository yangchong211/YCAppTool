...
public class MovieWebViewActivity extends BaseActivity {
    ...
    private String alt;
    private String name;
    private MovieWebViewActivity activity;
    ...
    public void initView() {
        activity = MovieWebViewActivity.this;
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public void onHideCustomView() {
            ...
            if (activity.getVideoFullView() != null) {
                activity.getVideoFullView().removeView(customView);
            }
            customView = null;
        ...
        private void openFileChooserImplForAndroid5(ValueCallback<Uri[]> uploadMsg) {
            ...
            activity.startActivityForResult(chooserIntent, 201);
        }
