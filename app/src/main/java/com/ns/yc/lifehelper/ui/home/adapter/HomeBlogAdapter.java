package com.ns.yc.lifehelper.ui.home.adapter;
...
public class HomeBlogAdapter extends BGARecyclerViewAdapter<HomeBlogEntity> {
    ...
    protected void fillData(BGAViewHolderHelper helper, int position, HomeBlogEntity model) {
        if(position==0){
            ...
            ImageUtils.loadImgByPicassoError(activity,model.getImageUrl(),R.drawable.bg_stack_blur_default,helper.getImageView(R.id.iv_img));
