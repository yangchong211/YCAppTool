package com.ns.yc.lifehelper.ui.other.bookReader.adapter;
 ...
 * ================================================
 */
public class SubHomeTopAdapter extends RecyclerArrayAdapter<BooksByCats.BooksBean> {

    private Activity activity;

    public SubHomeTopAdapter(Activity activity) {
        super(activity);
