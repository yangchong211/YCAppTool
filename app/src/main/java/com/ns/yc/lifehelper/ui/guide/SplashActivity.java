...
public class SplashActivity extends BaseActivity {
    ...
    private void initSplashListener() {
        GuideViewPagerAdapter adapter = new GuideViewPagerAdapter(views, this);
            ...
            public void onPageSelected(int position) {
                ...
                if (position + 1 == vpPager.getAdapter().getCount()) {
                    if (btnGo.getVisibility() != View.VISIBLE) {
                        ...
                        btnGo.startAnimation(AnimationUtils.loadAnimation(SplashActivity.this, android.R.anim.fade_in));
                    }
                } else {
                    if (btnGo.getVisibility() != View.GONE) {
                        btnGo.setVisibility(View.GONE);
                        btnGo.startAnimation(AnimationUtils.loadAnimation(SplashActivity.this, android.R.anim.fade_out));
                    }
                }
            }
