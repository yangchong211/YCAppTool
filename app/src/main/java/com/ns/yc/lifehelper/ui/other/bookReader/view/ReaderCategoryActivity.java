...
import com.ns.yc.lifehelper.ui.other.bookReader.adapter.CategoryListAdapter;
...
public class ReaderCategoryActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ReaderCategoryActivity activity;
    ...
    public void initView() {
        activity = ReaderCategoryActivity.this;
        initToolBar();
        initRecycleView();
    }
    ...
    private void initRecycleView() {
        ...
        maleAdapter = new CategoryListAdapter(activity, mMaleCategoryList, new ClickListener(Constant.Gender.MALE));
        femaleAdapter = new CategoryListAdapter(activity, mFemaleCategoryList, new ClickListener(Constant.Gender.FEMALE));
    ...
    class ClickListener implements OnRvItemClickListener<CategoryList.MaleBean> {
        ...
        public void onItemClick(View view, int position, CategoryList.MaleBean data) {
            Intent intent = new Intent(activity,SubCategoryListActivity.class);
