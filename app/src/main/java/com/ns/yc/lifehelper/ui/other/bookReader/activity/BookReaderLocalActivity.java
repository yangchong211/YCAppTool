...
public class BookReaderLocalActivity extends BaseActivity implements View.OnClickListener {
    ...
    private BookReaderLocalActivity activity;
    ...
    public void initView() {
        activity = BookReaderLocalActivity.this;
        initToolBar();
        initRecycleView();
    }
    ...
    private void initRecycleView() {
        ...
        adapter = new ReaderLocalAdapter(activity);
    ...
    private void startQueryFiles() {
        ...
        // cache
        String bookPath = FileUtils.createRootPath(activity.getApplicationContext());
    ...
    private void initOnItemClick(int position) {
        ...
        if (books.path.endsWith(ConstantBookReader.SUFFIX_TXT)) {
            ...
            // PDF
            Intent intent = new Intent(activity, BookReadPDFActivity.class);
            intent.setAction(Intent.ACTION_VIEW);
            intent.setData(Uri.fromFile(new File(books.path)));
            activity.startActivity(intent);
        } else if (books.path.endsWith(ConstantBookReader.SUFFIX_EPUB)) {
            // EPub
            Intent intent = new Intent(activity, BookReadPubActivity.class);
            intent.setAction(Intent.ACTION_VIEW);
            intent.setData(Uri.fromFile(new File(books.path)));
            activity.startActivity(intent);
        } else if (books.path.endsWith(ConstantBookReader.SUFFIX_CHM)) {
            // CHM
            Intent intent = new Intent(activity, BookReadChmActivity.class);
            intent.setAction(Intent.ACTION_VIEW);
            intent.setData(Uri.fromFile(new File(books.path)));
            activity.startActivity(intent);
        }
    ...
    public void showTipViewAndDelayClose(String tip) {
        final TextView tipView = new TextView(activity);
        tipView.setText(tip);
