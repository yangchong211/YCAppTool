package com.ns.yc.lifehelper.ui.data.adapter;
...
public class DataToolAdapter extends BaseAdapter {
    ...
    private int[] toolLogo;
    private MainActivity activity;

    public DataToolAdapter(MainActivity activity, String[] toolName, int[] toolLogo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.iv_nul.setImageResource(toolLogo[position]);
        return convertView;
    }
