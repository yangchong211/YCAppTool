        ...
        public void setData(GanKIoDataBean.ResultsBean data) {
            ...
            if(data.getType()!=null && data.getType().equals("福利")){
                if(data.getImages()!=null && data.getImages().size()>0){
                    ...
                    ImageUtils.displayGif(getContext(),data.getImages().get(0),R.drawable.shape_load_error_img,iv_all_welfare);
                } else {
                ...
                if(data.getImages()!=null && data.getImages().size()>0){
                    ...
                    ImageUtils.displayGif(getContext(),data.getImages().get(0),R.drawable.shape_load_error_img,iv_android_pic);
                } else {
