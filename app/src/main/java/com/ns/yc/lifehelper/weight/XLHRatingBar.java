...
public class XLHRatingBar extends LinearLayout {
    ...
    public XLHRatingBar(Context context, AttributeSet attrs) {
        ...
        widthAndHeight = typedArray.getDimension(R.styleable.XlHRatingBar_widthAndHeight, SizeUtils.dp2px(0));
        dividerWidth = typedArray.getDimension(R.styleable.XlHRatingBar_dividerWidth, SizeUtils.dp2px(0));
