package com.ns.yc.lifehelper.ui.other.myNews.wxNews.adapter;
 ...
 * ================================================
 */
public class WxNewsAdapter extends RecyclerArrayAdapter<WxNewsDetailBean.ResultBean.ListBean> {

    public WxNewsAdapter(Activity activity) {
        super(activity);
    }
