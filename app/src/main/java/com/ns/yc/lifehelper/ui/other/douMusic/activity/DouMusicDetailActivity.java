package com.ns.yc.lifehelper.ui.other.douMusic.activity;
...
public class DouMusicDetailActivity extends BaseActivity {
    ...
    private DouMusicDetailActivity activity;
    ...
    public void initView() {
        activity = DouMusicDetailActivity.this;
        initIntentData();
        setTitleBar();
        setMotion();
        setPicture();
    ...
    private void initIntentData() {
        ...
        if(intent!=null){
            ...
            ImageUtils.loadImgByPicasso(activity, image,ivMusicPhoto);
    ...
    private void initScrollViewListener() {
        ...
        int titleBarAndStatusHeight = (int) (activity.getResources().getDimension(R.dimen.nav_bar_height) + StatusBarUtils.getStatusBarHeight(this));
        slidingDistance = imageBgHeight - titleBarAndStatusHeight - (int) (activity.getResources().getDimension(R.dimen.nav_bar_height_more));
    }
