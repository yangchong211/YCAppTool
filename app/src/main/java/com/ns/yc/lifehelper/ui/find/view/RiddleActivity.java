package com.ns.yc.lifehelper.ui.find.view;
...
import com.ns.yc.lifehelper.ui.find.adapter.PicRiddleAdapter;
...
public class RiddleActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initGridView() {
        final PicRiddleAdapter adapter = new PicRiddleAdapter(activity,titles);
        gridView.setAdapter(adapter);
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(titles.length>=position){
                    Intent intent = new Intent(activity,RiddleDetailActivity.class);
