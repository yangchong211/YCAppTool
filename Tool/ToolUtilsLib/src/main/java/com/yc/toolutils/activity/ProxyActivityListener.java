...
public class ProxyActivityListener extends ActivityLifecycleListener {
    ...
    public void registerActivityLifecycleListener(Class clazz, ActivityLifecycleListener lifecycleListener) {
    ...
    public boolean unregisterActivityLifecycleListener(Class clazz, ActivityLifecycleListener lifecycleListener) {
        if (clazz == null || lifecycleListener == null) {
            return false;
        }
