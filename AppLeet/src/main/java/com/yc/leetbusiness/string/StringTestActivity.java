package com.yc.leetbusiness.string;
...
public class StringTestActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int getContentView() {
        return R.layout.activity_leet_string;
    }
