package com.yc.leetbusiness.stack;
...
public class StackTestActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int getContentView() {
        return R.layout.activity_leet_stack;
    }
